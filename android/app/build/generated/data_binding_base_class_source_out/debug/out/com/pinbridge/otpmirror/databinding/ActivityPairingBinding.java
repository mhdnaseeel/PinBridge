...
public final class ActivityPairingBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView pairingInfo;

  @NonNull
  public final ImageView qrCodeImage;

  private ActivityPairingBinding(@NonNull LinearLayout rootView, @NonNull TextView pairingInfo,
  ...
  public static ActivityPairingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.pairingInfo;
      TextView pairingInfo = ViewBindings.findChildViewById(rootView, id);
      if (pairingInfo == null) {
        break missingId;
      }
      ...
      return new ActivityPairingBinding((LinearLayout) rootView, pairingInfo, qrCodeImage);
    }
